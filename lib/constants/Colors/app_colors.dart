...
class AppColors{
  ...
  static const Color secondaryColorDark = Color(0xFFFFEB3B);
  static const Color textColorDark = Color(0xFF6B86B6);

  static const Color primaryColorLight = Color(0xFFFFFFFF);
  static const Color secondaryColorLight = Color(0xFFFF3B3B);
  ...
  //VIOLET
  static const Color violet50 = Color(0xFFF3E5F5);
  static const Color violet100 = Color(0xFFE1BEE7);
  static const Color violet200 = Color(0xFFCE93D8);
  static const Color violet300 = Color(0xFFBA68C8);
  static const Color violet400 = Color(0xFFAB47BC);
  static const Color violet500 = Color(0xFF9C27B0);
  static const Color violet600 = Color(0xFF8E24AA);
  static const Color violet700 = Color(0xFF7B1FA2);
  static const Color violet800 = Color(0xFF6A1B9A);
  static const Color violet900 = Color(0xFF4A148C);
  static const Color violetA100 = Color(0xFFEA80FC);
  static const Color violetA200 = Color(0xFFE040FB);
  static const Color violetA400 = Color(0xFFD500F9);
  static const Color violetA700 = Color(0xFFAA00FF);
